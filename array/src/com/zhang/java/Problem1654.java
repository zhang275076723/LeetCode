 ...
 * @Date 2023/9/2 08:59
 * @Author zsy
 * @Description 到家的最少跳跃次数 类比Problem815、Problem2059、LCP09 跳跃问题类比Problem45、Problem55、Problem403、Problem975、Problem1306、Problem1340、Problem1345、Problem1377、Problem1696、Problem1871、Problem2297、Problem2498、Problem2770、LCP09
...
//        int x = 2000;
    ...
    /**
     * bfs
     * 难点：如果确定能够最大跳跃到的右边界，如果不限制右边界，则无法跳出bfs循环
