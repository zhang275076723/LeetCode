 ...
 * @Date 2022/9/9 8:43
 * @Author zsy
 * @Description 分割数组为连续子序列 类比Problem460、Problem621、Offer61 分割类比Problem698、Problem725 子序列和子数组类比Problem53、Problem115、Problem152、Problem209、Problem300、Problem325、Problem392、Problem491、Problem516、Problem525、Problem560、Problem581、Problem673、Problem674、Problem718、Problem862、Problem1143、Offer42、Offer57_2
...
public class Problem659 {
    ...
    public boolean isPossible(int[] nums) {
        ...
        //key：连续子序列的结尾元素，value：以key结尾的连续子序列长度的小根堆
        Map<Integer, Queue<Integer>> map = new HashMap<>();

        for (int num : nums) {
            //map中存在以num-1结尾的连续子序列长度的小根堆，取出小根堆中长度最小的连续子序列，放入长度+1的小根堆中
        ...
        //判断哈希表中小根堆是否存在长度小于3的连续子序列，如果存在，直接返回false
