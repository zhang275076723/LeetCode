 ...
 * @Date 2023/5/5 09:01
 * @Author zsy
 * @Description 递增子序列 回溯+剪枝类比Problem17、Problem39、Problem40、Problem46、Problem47、Problem77、Problem78、Problem90、Problem97、Problem216、Problem377、Problem679、Offer17、Offer38 子序列和子数组类比子序列和子数组类比Problem53、Problem115、Problem152、Problem209、Problem300、Problem325、Problem392、Problem516、Problem525、Problem560、Problem581、Problem659、Problem673、Problem674、Problem718、Problem862、Problem1143、Offer42、Offer57_2
...
public class Problem491 {
    ...
    public List<List<Integer>> findSubsequences(int[] nums) {
        ...
        //last表示前一个选择的元素，初始化nums[0]的前一个选择的元素为int最小值，表示nums[0]满足递增子序列
