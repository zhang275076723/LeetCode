 ...
 * @Author zsy
 * @Description 不同岛屿的数量 II dfs和bfs类比Problem79、Problem130、Problem200、Problem212、Problem463、Problem490、Problem499、Problem505、Problem529、Problem547、Problem694、Problem695、Problem733、Problem827、Problem994、Problem1034、Problem1162、Problem1254、Problem1568、Problem1905、Offer12
...
public class Problem711 {
     ...
     * 计算每种情况中节点减去当前情况的最小横纵坐标节点，得到相对节点，8种情况的相对节点作为唯一标识太长，
     * 所以由小到大排序8种情况的相对节点，排序后最小情况的相对节点作为当前岛屿的唯一标识，
     * 如果当前岛屿的标记在之前保存的标记中出现过，则存在相同岛屿
     * 注意：必须减去当前情况的最小横纵坐标节点，而不能像694题一样减去起始节点的横纵坐标节点
     * 原坐标：(x,y)
     * 上下翻转：(x,-y)
     * 左右翻转：(-x,y)
     * 顺时针旋转90°：(y,-x)
    ...
    public int numDistinctIslands(int[][] grid) {
        //保存不同岛屿唯一标识的set集合，当前岛屿中每个节点经过旋转或翻转，得到8种不同的情况，
        //计算每种情况中节点减去当前情况的最小横纵坐标节点，得到相对节点，8种情况的相对节点作为唯一标识太长，
        //所以由小到大排序8种情况的相对节点，排序后最小情况的相对节点作为当前岛屿的唯一标识
    ...
    private String getKey(List<int[]> list) {
        //当前岛屿中每个节点经过旋转或翻转，得到8种不同的情况，
        //计算每种情况中节点减去当前情况的最小横纵坐标节点，得到相对节点的集合数组，只有8种不同情况的节点
        ...
        //每种情况按照节点横坐标和纵坐标由小到大排序，才能减去当前情况的最小横纵坐标节点，得到相对节点
        //注意：必须减去当前情况的最小横纵坐标节点，而不能像694题一样减去起始节点的横纵坐标节点
        ...
        //8种情况的相对节点作为唯一标识太长，所以由小到大排序8种情况的相对节点，排序后最小情况的相对节点作为当前岛屿的唯一标识
