 ...
 * @Author zsy
 * @Description 无重叠区间 类比Problem56、Problem57、Problem252、Problem253、Problem406、Problem763 动态规划类比Problem300
...
public class Problem435 {
    ...
    /**
     * 按照左区间interval[i][0]由小到大排序，当前区间和右边界存在重叠部分时，
     * 取两者中最小值更新右边界，保证下一个区间和右边界不重叠
