 ...
 * @Date 2023/8/3 08:45
 * @Author zsy
 * @Description 三个数的最大乘积 类比Problem334 类比Problem581 类比Problem747、Problem1131、Problem1330、Problem1509 类比Problem128、Problem506、Problem539、Problem561、Problem747、Problem1200、Problem1509、Problem2144
...
public class Problem628 {
    ...
    public int maximumProduct2(int[] nums) {
        ...
        //nums中三个数的最大乘积是最大的三个数相乘与最小的两个数和最大的数相乘中的较大值
