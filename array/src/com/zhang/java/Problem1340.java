 ...
 * @Author zsy
 * @Description 跳跃游戏 V 跳跃问题类比Problem45、Problem55、Problem403、Problem1306、Problem1345、Problem1654、Problem1696、Problem1871、Problem2498 动态规划类比Problem198、Problem213、Problem279、Problem322、Problem343、Problem377、Problem416、Problem474、Problem494、Problem518、Problem746、Problem983、Problem1388、Problem1444、Offer14、Offer14_2、Offer60、CircleBackToOrigin、Knapsack 记忆化搜索类比Problem62、Problem63、Problem64、Problem70、Problem329、Problem509、Problem1388、Problem1444、Offer10、Offer10_2
...
//        int d = 2;
     ...
     * 时间复杂度O(nlogn+nd)，空间复杂度O(n) (排序的时间复杂度O(nlogn))
     *
     * @param arr
     * @param d
     * @return
