 ...
 * @Author zsy
 * @Description 两数之和 IV - 输入二叉搜索树 类比Problem173、Problem538、Problem1214、Offer54 类比Problem1、Problem15、Problem16、Problem18、Problem167、Problem170、Problem454、Problem1099、Offer57 双指针类比
...
public class Problem653 {
    ...
    /**
     * 中序遍历+双指针
     * 利用二叉搜索树性质，即中序遍历有序，双指针分别指向中序遍历的第一个节点和最后一个节点
     * 时间复杂度O(n)，空间复杂度O(n)
     *
     * @param root
     * @param k
