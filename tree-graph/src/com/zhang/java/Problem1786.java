 ...
 * @Author zsy
 * @Description 从第一个节点出发到最后一个节点的受限路径数 图中最短路径类比Problem399、Problem743、Problem787、Problem882、Problem1293、Problem1334、Problem1368、Problem1462、Problem1514、Problem1631、Problem1928、Problem1976、Problem2045、Problem2093、Problem2203、Problem2290、Problem2473、Problem2662、Dijkstra 拓扑排序类比
...
//        int[][] edges = {{1, 2, 3}, {1, 3, 3}, {2, 3, 1}, {1, 4, 2}, {5, 2, 2}, {3, 5, 1}, {5, 4, 10}};
     ...
     * Dijkstra保证有向图中相连的两个节点到节点n的最短路径长度递减，即满足受限路径，
    ...
    public int countRestrictedPaths(int n, int[][] edges) {
        ...
        //key：当前节点，value：当前节点的邻接节点和权值的映射
