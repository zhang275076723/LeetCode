...
public class Problem310 {
    ...
    /**
     * bfs拓扑排序
     * 核心思想：像剪枝一样，一层层把最外层，即度为1的节点去除，最后剩下的1个或2个节点即为图中最小高度对应的根节点
     * 图中度为1的节点不是图中最小高度对应的根节点，加入队列中，队列中节点出队，
     * 每次删除当前层中的所有节点相连的边，即对应节点的度减1，如果存在新的度为1的节点，则入队，
    ...
    public List<Integer> findMinHeightTrees2(int n, int[][] edges) {
        ...
        while (count > 2) {
            ...
            //否则只能得到2个图中最小高度对应的根节点，没有考虑到只有1个图中最小高度对应的根节点
            for (int i = 0; i < size; i++) {
                int u = queue.poll();

                //删除当前节点相连的边，即对应节点的度减1，如果存在新的度为1的节点，则入队
