...
public class Problem1368 {
    ...
    /**
     * bfs
     * 注意：当前路径长度不是经过的节点个数，而是到达当前节点需要修改的方向个数
