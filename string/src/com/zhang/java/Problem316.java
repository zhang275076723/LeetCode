 ...
 * @Author zsy
 * @Description 去除重复字母 腾讯面试题 华为面试题 单调栈类比Problem42、Problem84、Problem255、Problem321、Problem402、Problem456、Problem496、Problem503、Problem654、Problem739、Problem795、Problem907、Problem1019、Problem1856、Problem2104、Problem2454、Problem2487、Offer33、DoubleStackSort
...
public class Problem316 {
    ...
    /**
     * 单调栈+哈希表 (求当前元素之后，比当前元素大或小的元素，就要想到单调栈)
