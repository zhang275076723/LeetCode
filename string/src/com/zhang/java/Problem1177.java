 ...
 * @Date 2024/3/8 08:13
 * @Author zsy
 * @Description 构建回文串检测 类比Problem1371、Problem1457、Problem1542、Problem2791 前缀和类比 状态压缩类比 回文类比Problem5、Problem9、Problem125、Problem131、Problem132、Problem214、Problem234、Problem266、Problem267、Problem336、Problem409、Problem479、Problem516、Problem647、Problem680、Problem866、Problem1147、Problem1312、Problem1328、Problem1332、Problem1400、Problem1616
...
public class Problem1177 {
     ...
     * preSum[left]^preSum[right+1]：s[left]-s[right]中字符出现的奇偶次数二进制表示的数
     * 当前子串出现次数为偶数的字符有a种，则这a种字符都可以构成回文；
     * 当前子串出现次数为奇数的字符有b种，需要修改b/2个字符，则这b种字符都可以构成回文
     * 注意：子串可以重新排列
