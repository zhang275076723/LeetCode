 ...
 * @Author zsy
 * @Description 统计前后缀下标对 II 同Problem3042 字符串哈希类比Problem187、Problem1044、Problem1062、Problem1316、Problem1392、Problem1698、Problem3029、Problem3031、Problem3042、Problem3076 前缀树类比
 ...
 */
public class Problem3045 {
    public static void main(String[] args) {
        Problem3045 problem3045 = new Problem3045();
//        String[] words = {"a", "aba", "ababa", "aa"};
        ...
        System.out.println(problem3045.countPrefixSuffixPairs(words));
        System.out.println(problem3045.countPrefixSuffixPairs2(words));
    }

    /**
     * 字符串哈希 (存在哈希冲突，但正确，可以通过双哈希降低冲突)
