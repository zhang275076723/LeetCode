 ...
 * @Author zsy
 * @Description 将单词恢复初始状态所需的最短时间 I kmp类比Problem28、Problem214、Problem459、Problem471、Problem686、Problem796、Problem1392、Problem1408 字符串哈希类比Problem187、Problem1044、Problem1316、Problem1392、Problem1698
...
public class Problem3029 {
     ...
     * 如果当前公共前缀和后缀长度能通过每次移除k个字符得到，则未匹配的剩余字符串长度除以k即为最短时间
     * 时间复杂度O(n)，空间复杂度O(n)
     *
     * @param word
     * @param k
