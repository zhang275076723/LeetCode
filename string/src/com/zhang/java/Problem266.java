...
public class Problem266 {
    ...
    /**
     * 哈希表
     * 统计字符串s中每个字符出现的次数，出现次数为偶数的字符都能构成回文串，出现次数为奇数的字符最多只能有1个，
     * 超过1个，则不能构成回文串
