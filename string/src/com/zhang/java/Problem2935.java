...
/**
 * @Date 2025/4/30 08:12
 * @Author zsy
 * @Description 找出强数对的最大异或值 II 同Problem2932 类比Problem421、Problem1707、Problem1803、Problem1938、Problem2479、Problem2932 前缀树类比
...
public class Problem2935 {
    public static void main(String[] args) {
        Problem2935 problem2935 = new Problem2935();
        int[] nums = {500, 520, 2500, 3000};
        System.out.println(problem2935.maximumStrongPairXor(nums));
        System.out.println(problem2935.maximumStrongPairXor2(nums));
    }
    ...
    private static class Trie {
        ...
        public void insert(int num) {
            ...
            for (int i = 30; i >= 0; i--) {
                ...
                if (node.children[cur] == null) {
                    node.children[cur] = new Trie.TrieNode();
                }
        ...
        private static class TrieNode {
            private final Trie.TrieNode[] children;
            //前缀树中根节点到当前节点作为二进制前缀包含的元素个数
            private int count;
            private boolean isEnd;

            public TrieNode() {
                children = new Trie.TrieNode[2];
                count = 0;
                isEnd = false;
            }
        }
