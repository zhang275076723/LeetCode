 ...
 * @Author zsy
 * @Description 同构字符串 哈希表类比Problem187、Problem242、Problem290、Problem291、Problem383、Problem387、Problem389、Problem554、Problem763、Problem1640、Offer50
...
public class Problem205 {
    ...
    public boolean isIsomorphic(String s, String t) {
        ...
        //t中字符到s中字符的映射map
        //注意：必须使用两个map，如果只使用一个map，假设s中字符'a'映射到t中字符'b'，同时也有s中字符'c'映射到t中字符'b'，
        //此时不满足不同字符不能映射到同一个字符，不是同构，使用一个map无法判断这种情况
