 ...
 * @Date 2023/5/6 08:20
 * @Author zsy
 * @Description 字符串的编码与解码 移位运算类比IPToInt 类比Problem38、Problem394、Problem443、Problem604 序列化类比Problem297、Problem331、Problem449、Offer37
...
//        Codec decoder = new Codec();
    ...
    /**
     * 分块编码，使用4字节表示每个字符串的长度，即最大能够表示2^32-1长度的字符串，HTTP1.1采用就是分块编码
     */
    static class Codec2 {
        /**
