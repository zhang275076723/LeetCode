 ...
 * @Author zsy
 * @Description 我的日程安排表 III 线段树类比Problem307、Problem308、Problem729、Problem731 二分搜索树类比Problem230、Problem440
...
public class Problem732 {
    ...
    static class MyCalendarThree {
        ...
        public int book(int start, int end) {
            ...
            //根节点root表示的区间[0,maxRight]元素的最大值，即为存在的最大预订次数
        ...
        private static class SegmentTree {
            ...
            private static class SegmentTreeNode {
                ...
                int lazyValue;
                SegmentTree.SegmentTreeNode leftNode;
                SegmentTree.SegmentTreeNode rightNode;
            }
        }
    }
}
