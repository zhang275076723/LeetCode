 ...
 * @Author zsy
 * @Description 键值映射 前缀树类比Problem14、Problem208、Problem211、Problem212、Problem336、Problem421、Problem676、Problem720、Problem745、Problem820、Problem1804、Problem3043
 * 设计一个 map ，满足以下几点:
 * 字符串表示键，整数表示值
