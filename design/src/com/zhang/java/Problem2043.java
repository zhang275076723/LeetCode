...
/**
 * @Date 2024/9/20 08:25
 * @Author zsy
 * @Description 简易银行系统 类比Problem2241
...
public class Problem2043 {
    ...
    static class Bank {
        ...
        public boolean transfer(int account1, int account2, long money) {
            //不存在account1、account2账户，或者account1账户余额小于money，则无法转账，返回false
        ...
        public boolean withdraw(int account, long money) {
            //不存在account账户，或者account账户余额小于money，则无法取款，返回false
