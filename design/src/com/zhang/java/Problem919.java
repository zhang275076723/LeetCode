 ...
 * @Date 2023/4/7 09:38
 * @Author zsy
 * @Description 完全二叉树插入器 完全二叉树类比Problem222、Problem958 位运算类比
...
//        CBTInserter2 cBTInserter = new CBTInserter2(root);
     ...
     * 第一位(从左往右)为1，则表示根节点下标索引；
     * 第二位(从左往右)为0，则表示往左子树找；
     * 第三位(从左往右)为1，则表示往右子树找，则找到当前节点的父节点；
     * 第四位(从左往右)为0，则表示当前节点插入父节点的左子树中
     */
