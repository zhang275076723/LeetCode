...
public class Problem258 {
    ...
    /**
     * 数学
     * 一个数xyz可以拆分为：100*x+10*y+z=99*x+9*y+x+y+z，99、9都能被9整除，
    ...
    public int addDigits2(int num) {
        ...
        //不能写为return num % 9;，需要考虑数xyz能被9整除的情况，如果直接模9，结果为0，则需要xyz先减1，模9，此时结果肯定不为0，再加1
        return (num - 1) % 9 + 1;
    }
}
