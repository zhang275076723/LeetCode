 ...
 * @Author zsy
 * @Description Nim 游戏 字节面试题 类比Problem258、Problem293、Problem294、Problem464、Problem1823、Offer62
...
public class Problem292 {
    ...
    /**
     * 数学，巴什博弈
     * n个物品，2名玩家轮流拿物品，每次只能拿1-m个物品，最后拿完物品的玩家胜利，只要n不能整除m+1，则先手拿物品的玩家胜利
