 ...
 * @Author zsy
 * @Description Nim 游戏 字节面试题 类比Problem258、Problem293、Problem294、Problem1823、Offer62
...
public class Problem292 {
     ...
     * 自己先手石头数量为i-1或i-2或i-3的情况下不能赢得游戏，则自己先手石头数量为i的情况下，总能拿1-3个石头，
     * 使对方先手石头数量为i-1或i-2或i-3的情况下不能赢得游戏，则自己就能赢得游戏
     * 时间复杂度O(n)，空间复杂度O(n)
     *
     * @param n
     * @return
