 ...
 * @Author zsy
 * @Description 阶乘后的零 小红书面试题 类比Problem1018 因子类比Problem829 模拟类比Problem60、Problem233、Problem400、Offer43、Offer44、Interview_17_06
...
public class Problem172 {
    ...
    /**
     * 模拟
     * 核心思想：1-n中每出现一个因子2和因子5，则1-n相乘末尾出现一个0，
