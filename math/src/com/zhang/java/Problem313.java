 ...
 * @Date 2023/9/8 08:41
 * @Author zsy
 * @Description 超级丑数 三指针类比Problem75、Problem264、Problem1201、Offer49 各种数类比Problem202、Problem204、Problem263、Problem264、Problem306、Problem507、Problem509、Problem728、Problem842、Problem878、Problem1201、Problem1291、Offer10、Offer49
...
//        int[] primes = {2, 7, 13, 19};
    ...
    public int nthSuperUglyNumber2(int n, int[] primes) {
        ...
        for (int i = 1; i < n; i++) {
            ...
            //通过dp1[dp2[i]]*primes[i]得到下一个超级丑数
            for (int j = 0; j < primes.length; j++) {
