...
//        int c = 5;
     ...
     * 小于等于n能被a整除的丑数个数记为A，小于等于n能被b整除的丑数个数记为B，小于等于n能被c整除的丑数个数记为C，
     ...
     * 时间复杂度O(log(n*min(a,b,c)-min(a,b,c)))=O(logn)，空间复杂度O(1)
     *
     * @param n
     * @param a
     * @param b
