 ...
 * @Author zsy
 * @Description 格雷编码 模拟类比Problem38 回溯+剪枝类比Problem17、Problem39、Problem40、Problem46、Problem47、Problem77、Problem78、Problem90、Problem97、Problem216、Problem377、Problem491、Problem679、Problem698、Offer17、Offer38
...
public class Problem89 {
     ...
     * 例如：n=2，4位格雷码为：00，01，10，11
     * n=3，前4位格雷码为：0(00)，0(01)，0(10)，0(11)，后4位格雷码为：1(11)，1(10)，1(01)，1(00)
     * 时间复杂度O(2^n)，空间复杂度O(1)
     *
     * @param n
     * @return
