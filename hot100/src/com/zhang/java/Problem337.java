 ...
 * @Author zsy
 * @Description 打家劫舍 III 类比Problem486、Problem877 类比Problem198、Problem213、Problem2560 dfs类比Problem124、Problem250、Problem298、Problem543、Problem687、Problem968、Problem979、Problem1245、Problem1372、Problem1373、Problem2246、Problem2378、Problem2925、Problem2973
...
public class Problem337 {
    ...
    /**
     * dfs
     * arr[0]：当前节点作为根节点的树中，不选当前节点能够盗取的最高金额
     * arr[1]：当前节点作为根节点的树中，选当前节点能够盗取的最高金额
