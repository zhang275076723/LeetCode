...
public class Problem003 {
    public static void main(String[] args) {
        ...
        String s = "pwwkew";
        System.out.println(problem003.lengthOfLongestSubstring(s));
        System.out.println(problem003.lengthOfLongestSubstring2(s));
        System.out.println(problem003.lengthOfLongestSubstring3(s));
    }
