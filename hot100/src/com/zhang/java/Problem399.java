 ...
 * @Date 2022/6/4 10:27
 * @Author zsy
 * @Description 除法求值 图中最短路径类比Problem743、Problem787、Problem882、Problem1293、Problem1334、Problem1368、Problem1462、Problem1514、Problem1631、Problem1786、Problem1928、Problem1976、Problem2045、Problem2093、Problem2203、Problem2290、Problem2473、Problem2662、Dijkstra 并查集类比Problem130、Problem200、Problem261、Problem305、Problem323、Problem547、Problem684、Problem685、Problem695、Problem765、Problem785、Problem827、Problem886、Problem952、Problem1135、Problem1254、Problem1319、Problem1361、Problem1489、Problem1568、Problem1584、Problem1627、Problem1905、Problem1998、Problem2685 图类比Problem133、Problem207、Problem210、Problem329、Problem785、Problem863
...
public class Problem399 {
    ...
    /**
     * dfs
     * 建立邻接矩阵形式的有向图，从起始节点dfs，判断是否能遍历到最终节点，再将结果保存
    ...
    /**
     * bfs
     * 建立邻接矩阵形式的有向图，从起始节点bfs，判断是否能遍历到最终节点，再将结果保存
     * 时间复杂度O(ML+Q(M+L))，空间复杂度O(NL+N^2) (M：边的数量，N：节点数量，Q：询问的数量，L：字符串的平均长度)
     *
     * @param equations
     * @param values
