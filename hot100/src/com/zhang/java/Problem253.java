 ...
 * @Date 2022/5/22 9:02
 * @Author zsy
 * @Description 会议室 II 携程机试题 区间类比Problem56、Problem57、Problem163、Problem228、Problem252、Problem352、Problem406、Problem435、Problem436、Problem763、Problem986、Problem1288
 * 给定一个会议时间安排的数组，
...
//        int[][] intervals = {{0, 30}, {5, 10}, {15, 20}};
     ...
     * 如果当前会议的开始时间大于等于小根堆堆顶会议的结束时间，则说明可以共享会议室，堆顶会议结束时间出堆，当前会议结束时间入堆；
     * 如果当前会议的开始时间小于小根堆堆顶会议的结束时间，则说明不能共享会议室，当前会议结束时间入堆
    ...
    public int minMeetingRooms(int[][] intervals) {
        ...
        for (int i = 1; i < intervals.length; i++) {
            ...
            if (intervals[i][0] >= priorityQueue.peek()) {
                ...
                //当前会议的开始时间小于小根堆堆顶会议的结束时间，则说明不能共享会议室，当前会议结束时间入堆
                priorityQueue.offer(intervals[i][1]);
            }
        }
