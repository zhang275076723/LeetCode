...
public class Problem560 {
    ...
    public int subarraySum2(int[] nums, int k) {
        ...
        //初始化，前缀和为0，0出现次数为1放入map，保证nums[0]-nums[i]之和为k的情况
        map.put(0, 1);
        ...
        for (int i = 0; i < nums.length; i++) {
            ...
            //map中存在key为pre-k的前缀和，则有满足子数组之和为k的情况，count累加
