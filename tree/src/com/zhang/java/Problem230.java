...
public class Problem230 {
     ...
     * 1、当前节点左节点为根节点的节点个数left小于k-1，则第k小节点在当前节点的右子树，查找当前节点的右子树的第k-1-left小
     * 2、当前节点左节点为根节点的节点个数left大于k-1，则第k小节点在当前节点的左子树，查找当前节点的左子树的第k小
     * 3、当前节点左节点为根节点的节点个数left等于k-1，则第k小节点即为当前节点，返回当前节点
     * 时间复杂度O(n)，空间复杂度O(n)
     *
     * @param root
     * @param k
    ...
    private static class MyTree {
        ...
        public int kthSmallest(int k) {
            ...
            while (count != k - 1) {
                //当前节点的节点个数小于k-1，则往右子树找
                if (count < k - 1) {
                    k = k - 1 - count;
                    node = node.right;
                } else {
                    //当前节点的节点个数大于k-1，则往左子树找
                    node = node.left;
                }
