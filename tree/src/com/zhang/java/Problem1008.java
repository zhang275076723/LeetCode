 ...
 * @Author zsy
 * @Description 前序遍历构造二叉搜索树 分治法类比Problem95、Problem105、Problem106、Problem108、Problem109、Problem255、Problem395、Problem449、Problem889、Offer7、Offer33
...
//        TreeNode root = problem1008.bstFromPreorder(preorder);
    ...
    /**
     * 分治法
     * 前序遍历数组第一个元素作为根节点，第一个节点之后到第一个比根节点值大的节点之前，都为左子树数组，之后都为右子树数组，
